...
Beginning with Red Hat&reg; Enterprise Linux&reg; (RHEL) 7 and CentOS 7, firewalld is available for managing iptables. As a 
result, you either need to use `firewall-cmd` commands or disable firewalld and enable iptables. This article shows you 
how to continue using the classic iptables setup.
