...
previews the changes that you can expect from a migration from version 5.1 to
5.6, and helps you ensure that your application is prepared for the change in
...
Back up the original instance first. If you discover any structure
discrepancies after you begin using the new MySQL 5.6 instance, you can
rebuild your database from this backup copy to its previous MySQL 5.1 state.
...
5. Enter a **Name** and **Description** for the backup and click **Create
   Backup**.
...
3. Click **Databases > MySQL Instance**.
...
1. In the Cloud Control Panel, click on the MySQL 5.1 instance. The list of
   databases displays on the Instance Details page.

2. Open the Instance Details page for the new MySQL 5.6 instance, click
   **Create Database**, and enter the name of a database from the 5.1
