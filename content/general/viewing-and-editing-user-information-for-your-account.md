...
- To add a new user, click **Create User**. On the **Create User** page, enter information for the new user's login, contact information, security question, and access level. For information about access controls for new users, see [Learning about Role-Based Access Control (RBAC)](/how-to/overview-role-based-access-control-rbac). After you have entered all of the information for the new user, click the **Create User** button at the bottom of the page.
