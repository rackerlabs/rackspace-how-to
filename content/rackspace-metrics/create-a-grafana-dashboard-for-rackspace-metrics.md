...
With annotation support, users can submit change event to show along with the graph, adding additional information for the graph on the dashboard. See [Use annotation support](/how-to/use-annotation-support) for additional information. 
